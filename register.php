...
if (isset($_POST['daftar'])) {
    ...
    // masukkan data ke dalam tabel user kolom kolom tabel user () dan nilainya di ambil dari inputan sesuai dengan urutan kolomnya
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title text-center">
                                <h5>Medsos X - Finka Ardhianissa</h5>
                            </div>
                            <form action="" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nama_pengguna" placeholder="Masukkan Nama Pengguna Anda">
                                </div>
                                <div class="form-group mb-3">
                                    <div class="d-grid">
